 ...
 * Body:
 * {
 *   "assessment_name": "Ignored; generated by the server",
...
try {
    ...
    // Assessment names are system-generated so every facility uses the same
    // predictable format and clients cannot replace it with custom text.
