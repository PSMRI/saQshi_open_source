...
try {
    ...
    if (!isset($cleanCheckpoints[$previousIndex])) {
        Response::success(
            'No previous checkpoint. This is the first checkpoint',
            [
                'has_previous' => false,
                'previous_checkpoint_id' => null,
    ...
    $previousCheckpointId = (int)$cleanCheckpoints[$previousIndex]['csqa_id'];

    Response::success(
        'Previous checkpoint fetched successfully',
        [
            'has_previous' => true,
            'current_checkpoint_id' => $checkpointId,
